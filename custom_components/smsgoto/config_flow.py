            ...
            try:
                ...
                if await client.test_connection():
                    return self.async_create_entry(
                        ...
                        data={
                            CONF_NAME: user_input.get(CONF_NAME, "SMS GoTo"),
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Required(CONF_API_KEY, description="Your GoTo API Key"): str,
                    vol.Required(CONF_API_SECRET, description="Your GoTo API Secret"): str,
                    vol.Required(CONF_ACCOUNT_SID, description="Your GoTo Account SID"): str,
                }
            ),
            errors=errors,
            description="Enter your GoTo API credentials to send SMS messages.",
        )
